<?php
    ...
    if(!isset($_GET["reset_token"]) || !isset($_GET["admin_id"])) {
        ...
        $admin_id = htmlspecialchars(trim($_GET["admin_id"]));

        $check_token_expiry = $conn->prepare("SELECT * FROM admin_accounts_tbl WHERE reset_password_token = :token AND admin_id = :admin_id LIMIT 1");
                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center"> Reset Administrator Password </p>

                                <form action="../../process/admin/admin-auth.php" method="POST">

                                    <input type="hidden" name="admin-id" value="<?php echo htmlspecialchars($admin_id); ?>">
