                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "profile" ? "show active" : ""); ?> pt-3" id="edit-information">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="../../process/admin/update-profile.php" method="POST" class="custom-form">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="email" class="form-control" id="email" name="email-address" placeholder="Last Name" value="<?php echo htmlspecialchars($email_address); ?>" required>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "photo" ? "show active" : ""); ?> pt-3" id="picture-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="../../process/admin/update-profile.php" method="POST" enctype="multipart/form-data">
