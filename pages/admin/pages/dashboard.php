<?php
    // Personnel Count
    $get_personnel_count = $conn->prepare("SELECT 
                                            COUNT(*) AS 'personnel_count' 
                                        FROM personnel_accounts_tbl");
    $get_personnel_count->execute();
    $personnel_count = $get_personnel_count->fetch()["personnel_count"];

    // Student Count
    $get_student_count = $conn->prepare("SELECT 
                                            COUNT(*) AS 'student_count' 
                                        FROM student_accounts_tbl");
    $get_student_count->execute();
    $student_count = $get_student_count->fetch()["student_count"];
    ...
    $get_maintenance_count->execute([":maintenance_status" => "Completed"]);
    ...
    <section class="section dashboard">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-md-6 mb-4">
                <a href="home.php?page=personnel-accounts" class="text-decoration-none">
                    <div class="card info-card shadow-sm border-0 hover-shadow">

                        <div class="card-body">
                            <h5 class="card-title text-dark mb-3">
                                <i class="bi bi-person-badge me-2 text-primary"></i>Personnel Accounts
                            </h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6 class="mb-0 text-dark"> <?php echo htmlspecialchars($personnel_count); ?> </h6>
            ...
            <!-- End Personnel Accounts -->

            <!-- Student Accounts -->
            <div class="col-xxl-3 col-md-6 mb-4">
                <a href="home.php?page=student-accounts" class="text-decoration-none">
                    <div class="card info-card shadow-sm border-0 hover-shadow">

                        <div class="card-body">
                            <h5 class="card-title text-dark mb-3">
                                <i class="bi bi-person-vcard me-2 text-success"></i>Student Accounts
                            </h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6 class="mb-0 text-dark"> <?php echo htmlspecialchars($student_count); ?> </h6>
                                    <span class="text-muted small"> Total Accounts </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xxl-3 col-md-6 mb-4">
                <a href="home.php?page=bin-monitoring" class="text-decoration-none">
                    <div class="card info-card shadow-sm border-0 hover-shadow">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-dark mb-3">
                                <i class="bi bi-trash me-2 text-danger"></i> Total Bins
                            </h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span class="text-muted small"> Maintenance Alerts </span>
                                </div>
                            </div>
                        </div>
