<?php
    ...
    if (empty($_SESSION["student-lrn"]) || $_SESSION["student-lrn"] === "" || $_SESSION["student-lrn"] === null) {
        ...
        $get_user_data = $conn->prepare("SELECT
                                                ...
                                                WHERE sa.student_lrn = :student_lrn
                                                LIMIT 1
                                            ");
        $get_user_data->execute([":student_lrn" => $student_lrn]);
        ...
        while ($user_data = $get_user_data->fetch(PDO::FETCH_OBJ)) {
            ...
            $student_points = $user_data->student_points;
