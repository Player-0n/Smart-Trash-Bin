<?php
    ...
    if(!isset($_GET["reset_token"]) || !isset($_GET["personnel_id"])) {
        ...
        $personnel_id = htmlspecialchars(trim($_GET["personnel_id"]));

        $check_token_expiry = $conn->prepare("SELECT * FROM personnel_accounts_tbl WHERE reset_password_token = :token AND personnel_id = :personnel_id LIMIT 1");
                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center"> Reset Personnel Password </p>

                                <form action="../../process/personnel/personnel-auth.php" method="POST">

                                    <input type="hidden" name="personnel-id" value="<?php echo htmlspecialchars($personnel_id); ?>">
